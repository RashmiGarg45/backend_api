...
class Bluerewards(models.Model):
    ...
    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='bluerewardsmodd')
    channel = models.CharField(default='', blank=True, max_length=100)
    network = models.CharField(default='', blank=True, max_length=100)
    offer_id = models.CharField(default='', blank=True, max_length=100)
...
class ShopeethiosUID(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='shopeetiosmodd')
    created_at = models.DateTimeField(auto_now_add=True)
    id = models.CharField(max_length=50,unique=True)    
    extra_details = models.JSONField(default = dict,blank=True, null=True)
    updated_at = models.DateTimeField(auto_now=True)    
...
class MyfriendUID(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='myfriendauto')
    created_at = models.DateTimeField(auto_now_add=True)
    id = models.CharField(max_length=50,unique=True)    
    extra_details = models.JSONField(default = dict,blank=True, null=True)
    updated_at = models.DateTimeField(auto_now=True)    
...
class MyfriendOID(models.Model):
...
class MambaUID(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='mambamodd')
    created_at = models.DateTimeField(auto_now_add=True)
    id = models.CharField(max_length=50,unique=True)    
    extra_details = models.JSONField(default = dict,blank=True, null=True)
    updated_at = models.DateTimeField(auto_now=True)    
...
class GalaxyChatCountry(models.Model):
...
class Alphacapital(models.Model):
    ...
    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='alphacapitalmodd')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class Bigloan(models.Model):
    ...
    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='bigloanmodd')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class Coinmena(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='coinmenaauto')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class Cabst13 (models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='13cabstauto')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class R888casino(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='r888casinomodd')
    created_at = models.DateTimeField(auto_now_add=True)
    id = models.CharField(max_length=50,unique=True)    
    extra_details = models.JSONField(default = dict,blank=True, null=True)
    updated_at = models.DateTimeField(auto_now=True)    
...
class Joybuy(models.Model):
    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='joybuymodd')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class Atomepht2uid(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='atomepht2modd')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class Atomepht2aid(models.Model):
...
class Myshift(models.Model):
    ...
    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='myshiftappmetricat')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class Hering(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='heringmodd')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class Babytracker(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='babytrackermodd')
    created_at = models.DateTimeField(auto_now_add=True)
    id = models.CharField(max_length=50,unique=True)    
    extra_details = models.JSONField(default = dict,blank=True, null=True)
    updated_at = models.DateTimeField(auto_now=True)    
    ...
    network = models.CharField(default='', blank=True, max_length=100)
    offer_id = models.CharField(default='', blank=True, max_length=100)
    is_premium =  models.CharField(default='', blank=True, max_length=100)
...
class Bitoasist(models.Model):
    ...
    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='bitoasistauto')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class EpochtimesUID(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='epochtimesmodd')
    created_at = models.DateTimeField(auto_now_add=True)
    id = models.CharField(max_length=50,unique=True)    
    extra_details = models.JSONField(default = dict,blank=True, null=True)
    updated_at = models.DateTimeField(auto_now=True)    
...
class Jyotiaiios(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='jyotiaiiosmodd')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class Shriram(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='shrirammodd')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class Cashmax(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='cashmaxmodd')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class Maxfashionindia_extra_OID(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='maxfashionindiaauto')
    created_at = models.DateTimeField(auto_now_add=True)
    ...
    updated_at = models.DateTimeField(auto_now=True)    
    used_at = models.DateTimeField(default = None,blank=True, null=True)
    waybill_pattern = models.CharField(default='', blank=True, max_length=2)
    channel = models.CharField(default='', blank=True, max_length=100)
    network = models.CharField(default='', blank=True, max_length=100)
    offer_id = models.CharField(default='', blank=True, max_length=100)
...
class MaxfashionindiaOID(models.Model):
...
class NGnumbers(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='ngapps')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    extra_details = models.JSONField(default = dict,blank=True, null=True)
...
class StyliOID(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='stylishshopauto')
    created_at = models.DateTimeField(auto_now_add=True)
    id = models.CharField(max_length=50,unique=True)
    waybillno = models.CharField(max_length=50,unique=True)
    order_type = models.CharField(default='', blank=True, max_length=30)
    order_date = models.DateTimeField(default=None,blank=True, null=True)
    extra_details = models.JSONField(default = dict,blank=True, null=True)
    price = models.FloatField(default=0)
    updated_at = models.DateTimeField(auto_now=True)    
...
class StylinewOID(models.Model):
...
class WizelyOID(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='wizelymodd')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class NetshoesOID(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='netshoesmodd')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class WizelyMining(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='wizelymodd')
    created_at = models.DateTimeField(auto_now_add=True)
    id = models.CharField(max_length=50,unique=True)
    orderNo = models.CharField(max_length=50,unique=True)
    quantity = models.CharField(default='', blank=True, max_length=30)
    orderDate = models.DateTimeField(default=None,blank=True, null=True)
    extra_details = models.JSONField(default = dict,blank=True, null=True)
    price = models.FloatField(default=0)
    updated_at = models.DateTimeField(auto_now=True)    
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class Timoclubuid(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='timoclubauto')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class MambanewUID(models.Model):
...
class MyfoodUID(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='myfoodappmetrica')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class Nirat(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='niratmodd')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class ScoreupUID(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='scoreup')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class BoylesportsUID(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='boylesportstmodd')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class SahiUID(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='sahimodd')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class AhamoveUID(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='ahamovemodd')
    created_at = models.DateTimeField(auto_now_add=True)
    id = models.CharField(max_length=50,unique=True)    
    extra_details = models.JSONField(default = dict,blank=True, null=True)
    updated_at = models.DateTimeField(auto_now=True)    
...
class ReevoNUMID(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='reevo')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class MbbankUID(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='mbbankmodd')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class AstroMining(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='astrogroceriest2modd')
    created_at = models.DateTimeField(auto_now_add=True)
    id = models.CharField(max_length=50,unique=True)
    updated_at = models.DateTimeField(auto_now=True)    
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class HealthifymeMining(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='healthifymetmodd')
    created_at = models.DateTimeField(auto_now_add=True)
    id = models.CharField(max_length=50,unique=True)
    joinedDate = models.DateTimeField(default=None,blank=True, null=True)
    extra_details = models.JSONField(default = dict,blank=True, null=True)    
    updated_at = models.DateTimeField(auto_now=True)    
    used_at = models.DateTimeField(default = None,blank=True, null=True)
    channel = models.CharField(default='', blank=True, max_length=100)
...
class DominosturkeyUID(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='dominosturkeyauto')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class DominosturkeyOID(models.Model):
...
class dominosturkey_OID(models.Model):
...
class abhibus_oid(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='abhibusauto')
    created_at = models.DateTimeField(auto_now_add=True)
    id = models.CharField(max_length=50,unique=True)
...
class DanaUID(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='danamodd')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class Spinny_OID(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='spinnytauto')
    created_at = models.DateTimeField(auto_now_add=True)
    id = models.CharField(max_length=50,unique=True)
    extra_details = models.JSONField(default = dict,blank=True, null=True)
    updated_at = models.DateTimeField(auto_now=True)    
...
class Spinny_valid_OID(models.Model):
...
class Dominoesgold_UID(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='dominoesgoldiosmodd')
    created_at = models.DateTimeField(auto_now_add=True)
    id = models.CharField(max_length=50,unique=True)
    extra_details = models.JSONField(default = dict,blank=True, null=True)
...
class Litres_UID(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='litresiosmodd')
    created_at = models.DateTimeField(auto_now_add=True)
    id = models.CharField(max_length=50,unique=True)
    extra_details = models.JSONField(default = dict,blank=True, null=True)
    user_is_verified = models.BooleanField(default=False)
    user_role = models.CharField(default='', blank=True, max_length=10)
    user_display_name = models.CharField(default='', blank=True, max_length=100)
    user_created_at = models.DateTimeField(default = None,blank=True, null=True)
    updated_at = models.DateTimeField(auto_now=True)    
    used_at = models.DateTimeField(default = None,blank=True, null=True)
    channel = models.CharField(default='', blank=True, max_length=100)
    network = models.CharField(default='', blank=True, max_length=100)
...
class NeonUID(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='neoniosmodd')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class PlantExpertOID(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='plantexpertaiiosmodd')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class MotilalNumber(models.Model):
...
class Sofyclub(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='sofyclubauto')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
...
class ApnatimeNumber(models.Model):
...
class ShiprocketCNY(models.Model):
...
class Globoplay(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='globoplaytmodd')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class LotterMX(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='lottermxiosmodd')
    created_at = models.DateTimeField(auto_now_add=True)
    id = models.CharField(max_length=50,unique=True)    
    IsFullyRegistered = models.CharField(max_length=50)
    IsCompleted = models.CharField(max_length=30)
...
class LotterUS(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='thelotterusiosmodd')
    created_at = models.DateTimeField(auto_now_add=True)
    id = models.CharField(max_length=50,unique=True)    
    IsFullyRegistered = models.CharField(max_length=50)
    IsCompleted = models.CharField(max_length=30)
...
class PizzahutMY(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='pizzahutmyauto')
    created_at = models.DateTimeField(auto_now_add=True)
    id = models.CharField(max_length=20,unique=True)
...
class FibeUID(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='fibeiosmodd')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class YangoUID(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='yangoplayiosmodd')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class CrecidineroUID(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='crecidineromxiosmodd')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class FortaprestUID(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='fortaprestiosmodd')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    id = models.CharField(max_length=50,unique=True)
    used_at = models.DateTimeField(default = None,blank=True, null=True)
...
class GrandPari(models.Model):

    serial = models.AutoField(primary_key=True, editable=False)
    campaign_name = models.CharField(max_length=20,default='grandparimodd')
    created_at = models.DateTimeField(auto_now_add=True)
    id = models.CharField(max_length=20,unique=True)
    extra_details = models.JSONField(default = dict,blank=True, null=True)
    updated_at = models.DateTimeField(auto_now=True)    
