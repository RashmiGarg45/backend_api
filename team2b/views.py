...
def mining_apps():
    ...
    mandate_list = ["indian_number", "scoreUp_uid","myshift_uid"]
...
class GenericScriptFunctions(APIView):
    def get(self, request):
        all_apps = {
            ...
            'epochtimes_UID': EpochtimesUID,
            'maxfashionindia_OID': MaxfashionindiaOID,
            'lifestyle_OID':LifetyleOrderId_2,
            'Eternz_OID':Eternz_OID,
            'dominoesgoldiosmodd_UID': Dominoesgold_UID,
            ...
            "myshift_uid":Myshift,
            "dominosturkey_orderid":dominosturkey_OID,
            'Spinny_OID':Spinny_OID,
            'litresiosmodd_UID': Litres_UID, 
            'epikoddiosmodd_UID': Epikodd,
            'lottermxiosmodd_UID': LotterMX
...
class GenericUnusedIdScriptFunctions(APIView):
    def get(self, request):
        ...
        for key in tablesDict.keys():
            ...
            data = {"total_count": query.count(), "oldest_id": query.first().created_at.strftime("%Y-%m-%d") if query else "Not available"}
            ids_mined[key] = data
...
class HabibOrderIdConstants(APIView):
    def put(self, request):
        ...
        query.campaign_name = request.data.get('camp_name','habibmodd')
        query.id = request.data.get('order_id')
        query.amount=request.data.get('amount')
        query.order_status=request.data.get('order_status')
        query.extra_details=request.data.get('extra_details',{})
...
class ConversionStats(APIView):
    def get(self, request):
        ...
        scripts_list = ["boylesportstmodd", "joybuymodd", "ocbcmodd", "raisinggoblinmodd","airmodd", "lineagewkrmodd", "galaxytmodd", "naukrigulftmodd", "muthootfinonemodd", "accorhotelstmodd", "shopeeno1tauto", "lionsgateplaytmodd", "musicallyt", "shopeephtauto", "casinoplussmodd", "zee5newmodd", "mcdeliverymodd", "poppolivetmodd", "smartqarzamodd", "magnittmodd", "waylettmodd", "juanhandmodd",'allobankmodd', "jazzcashmodd", "jazzcashnewmodd", "jupitertmodd", "onepuchmanmodd", "mxplayertmodd", "bigloanmodd", "kisshttmodd", "betwinnerngmodd","clonemcdeliverymodd", "danamodd", "ajiomodd", "idntimesmodd", "paymayamodd", "osagomodd", "mtcmusicmodd", "mbbankmodd", "wizelymodd", "webullmodd", "ahamovemodd", "opaymodd", "ballmodd", "heringmodd", "tikettmodd", "etomomodd", "robotzaimerrmodd", "stolototmodd", "netshoesmodd", "shrirammodd", "credmaxmodd", "tunaikutmodd", "paytmmoneytmodd", "foxtalemodd", "gamerummyprimemodd", "bcsinvestmenttmodd", "myacuvuemodd", "viuhkmodd", "yesmadammodd", "byutmodd", "indigomoddteam2modd", "roxmodd", "igpmodd", "cryptocomtmodd", "intercopromodd", "waylettnewmodd", "kubizmodd", "babytrackermodd", "tangledropemodd", "titanfincorpmodd", "opaynewmodd", "lulumoneymodd", "dbbetmodd", "mexdinmodd", "deltamodd", "yourloanmodd", "lirunexmodd", "epocosmeticmodd", "caroutmodd", "fastparimodd", "teraboxmodd", "beetlessolitairemodd", "eaptekatmodd", "digitalbankmodd", "bbvamodd", "bbvacomodd", "quickcashonlinemodd", "betrmodd", "heliummobilemodd", "kfcmexicotmodd", "comparemodd", "yesmadammodd", "rupeeredeemodd", "zeptodeliverymodd", "easycashtmodd", "finnixtmodd", "myntmodd", "alphacapitalmodd", "r888casinomodd","mibptmodd", "instamoneyquickmodd","lemon8newmodd","fiverrt2modd","cencemodd","carjammodd","sunlighttmodd","makebykbankiosmodd","pizzahutidmodd","bcsinvestiosmodd","sahimodd","stablemoneynewmodd","dairamodd","healthifymetmodd","jiomartiosmodd","astrogroceriest2modd","popaimodd","sushigallerymodd","mmsmodd","cubiosmodd","williamhillsportiosmodd","rootcarinsurancemodd","webzaimiosmodd","loansonlinemodd","intersendmoneymodd","eternzmodd","endingsteelwingmodd","starzplayiosmodd","jiofinancemodd","creditgiosmodd","shahidmodd", "globoplaytmodd", "moneyviewmodd", "pointsbetsportsbookmodd", "vegasiosmodd", "pulszcasinomodd", "bluerewardsmodd", "techcombankmodd"]
...
class GalaxyChatCountryAPI(APIView):
    ...
    def get(self, request):
        ...
        query_list = GalaxyChatCountry.objects.filter(used_at=None).filter(Q(from_selfcall__contains="alse") |Q(from_selfcall__contains="Report")).exclude(**exclude_dict_1).order_by('-created_at')[0:25].all()        
        if not query_list and random.randint(1,100)<=70:
            print ("Galaxy in not function")
            query_list = GalaxyChatCountry.objects.filter(from_selfcall__contains = "alse").exclude(**exclude_dict).order_by('-created_at')[0:25].all()
...
class Atomepht2aidAPI(APIView):
    ...
    def get(self, request):
        ...
        if setUsed:
            query = Atomepht2aid.objects.filter(id=data.get('agent_id')).update(used_at=timezone.now())
        return Response({
            'body':data,
        })
...
class BitoasistAPI(APIView):
    def put(self, request):
        query = Bitoasist()
        query.campaign_name = request.data.get('camp_name','bitoasistauto')
        query.id = request.data.get('user_id')
        query.used_at = None
        query.save()
        return Response({
    ...
    def get(self, request):
        ...
        query = Bitoasist.objects.latest('created_at')
...
class EpochtimesuidAPI(APIView):
    def put(self, request):
        query = EpochtimesUID()
        query.campaign_name = request.data.get('camp_name','epochtimesmodd')
        query.id = request.data.get('user_id')
        query.extra_details = request.data.get('extra_details',{})
        query.used_at = None
        query.save()
    ...
    def get(self, request):
        ...
        query = EpochtimesUID.objects.filter(used_at=None).order_by('-created_at')[0:50].first()
    ...
    def post(self, request):
        query = EpochtimesUID.objects.order_by('-id').first()
...
class JyotiaiiosAPI(APIView):
    def put(self, request):
        query = Jyotiaiios()
        query.campaign_name = request.data.get('camp_name','jyotiaiiosmodd')
        query.id = request.data.get('order_id')
        query.used_at = None
        query.save()
        return Response({
    ...
    def get(self, request):
        ...
        query = Jyotiaiios.objects.latest('created_at')
...
class ShriramAPI(APIView):
    def put(self, request):
        query = Shriram()
        query.campaign_name = request.data.get('camp_name','shrirammodd')
        query.id = request.data.get('user_id')
        query.used_at = None
        query.save()
        return Response({
    ...
    def get(self, request):
        ...
        query = Shriram.objects.latest('created_at')
...
class CashmaxAPI(APIView):
    def put(self, request):
        query = Cashmax()
        query.campaign_name = request.data.get('camp_name','cashmaxmodd')
        query.id = request.data.get('user_id')
        query.used_at = None
        query.save()
        return Response({
    ...
    def get(self, request):
        ...
        query = Cashmax.objects.latest('created_at')
...
class MaxfashionindiaOIDAPI(APIView):
    def put(self, request):
        query = MaxfashionindiaOID()
        query.campaign_name = request.data.get('camp_name','maxfashionindiaauto')
        query.id = request.data.get('order_id')
        query.airwaybillno = request.data.get('airwaybillno')
        query.order_no = request.data.get('order_no')
        ...
        try:
            ...
            if 'Duplicate entry' in str(e):
                query = Maxfashionindia_extra_OID()
                query.campaign_name = request.data.get('camp_name','maxfashionindiaauto')
                query.id = request.data.get('order_id')
                query.airwaybillno = request.data.get('airwaybillno')
                query.order_no = request.data.get('order_no')
    ...
    def get(self, request):
        ...
        query = MaxfashionindiaOID.objects.filter(used_at=None).order_by('-created_at')[0:50].first()
...
class NGnumbersAPI(APIView):
    ...
    def get(self, request):
        ...
        query_list = NGnumbers.objects.filter(used_at=None).exclude(**exclude_dict_1).order_by('-created_at')[0:25].all()        
        if not query_list:
            query_list = NGnumbers.objects.exclude(**exclude_dict).order_by('-created_at')[0:25].all()
...
class AbhibusAPI(APIView):

    def put(self, request):
        query = Abhibus()
        query.campaign_name = request.data.get('camp_name','abhibusauto')
        query.id = request.data.get('order_id')
        query.used_at = None
        try:
            query.save()
...
class StyliOIDAPI(APIView):
    def put(self, request):
        query = StyliOID()
        query.campaign_name = request.data.get('camp_name','stylishshopauto')
        query.id = request.data.get('order_id')
        query.waybillno = request.data.get('waybill')
        query.order_type = request.data.get('order_type','')
        query.order_date = request.data.get('order_date','')
        query.extra_details = request.data.get('extra_details',{})
        query.price = request.data.get("price", 0)
        query.used_at = None
        try:
            query.save()
            return Response({
    ...
    def get(self, request):
        ...
        query = StyliOID.objects.filter(used_at=None, id__startswith="0009", order_type="PREPAID").order_by('-created_at')[0:50].first()
    ...
    def post(self, request):
        query = StyliOID.objects.order_by('-waybillno').first()
...
class StylinewOIDAPI(APIView):
    def put(self, request):
        ...
        query.extra_details = request.data.get('extra_details',{})
        query.price = request.data.get("price", 0)
        query.actual_price = request.data.get("actual_price")
        query.difference = request.data.get("difference")
        query.sku = request.data.get("sku")
        query.used_at = None
        try:
            query.save()
            return Response({
    ...
    def get(self, request):
        ...
        query = StylinewOID.objects.filter(used_at=None, id__startswith="0009", order_type="PREPAID").order_by('-created_at')[0:50].first()
    ...
    def post(self, request):
        query = StylinewOID.objects.order_by('-waybillno').first()
...
class WizelyMiningAPI(APIView):
    def put(self, request):
        query = WizelyMining()
        query.campaign_name = request.data.get('camp_name','wizelymodd')
        query.id = request.data.get('transaction_id')
        query.orderNo = request.data.get('orderNo')
        query.orderDate = request.data.get('orderDate','')
        query.extra_details = request.data.get('extra_details',{})
        query.price = request.data.get("price", 0)
        query.quantity = request.data.get("quantity")
        query.used_at = None
        try:
            query.save()
            return Response({
    ...
    def get(self, request):
        ...
        query = WizelyMining.objects.filter(used_at=None).order_by('-created_at')[0:50].first()
    ...
    def post(self, request):
        query = WizelyMining.objects.order_by('-id').first()
...
class TimoclubuidAPI(APIView):
    ...
    def get(self, request):
        ...
        query = Timoclubuid.objects.latest('created_at')
...
class MambanewUIDAPI(APIView):
    ...
    def get(self, request):
        ...
        query = MambanewUID.objects.latest('created_at')
...
class WizelyUIDAPI(APIView):
    ...
    def get(self, request):
        ...
        query = WizelyUID.objects.latest('created_at')
...
class MyfoodoidAPI(APIView):
    ...
    def get(self, request):
        ...
        query = MyfoodOID.objects.latest('created_at')
...
class DabdoobuidAPI(APIView):
    def put(self, request):
        query = DabdoobUID()
        query.campaign_name = request.data.get('camp_name','dabdoobauto')
        query.id = request.data.get('user_id')
        query.used_at = None
        query.save()
        return Response({
    ...
    def get(self, request):
        ...
        query = DabdoobUID.objects.latest('created_at')
...
class DabdooboidAPI(APIView):
    ...
    def get(self, request):
        ...
        query = DabdoobOID.objects.latest('created_at')
...
class NumbersPKAPI(APIView):
    ...
    def get(self, request):
        ...
        query = list(NumbersPK.objects.filter(operator="JAZZ", used_at=None).order_by('-created_at').values_list('id', flat=True)[:50])
...
class NiratAPI(APIView):
    ...
    def put(self, request):
        query = Nirat()
        query.campaign_name = request.data.get('camp_name','niratmodd')
        query.id = request.data.get('user_id')
        query.used_at = None
        try:
            query.save()
    ...
    def get(self, request):
        ...
        query_list = Nirat.objects.filter(used_at=None).exclude(**exclude_dict_1).order_by('-created_at')[0:25].all()        
        if not query_list:
            query_list = Nirat.objects.exclude(**exclude_dict).order_by('-created_at')[0:25].all()
...
class ScoreupuidAPI(APIView):
    def put(self, request):
        query = ScoreupUID()
        query.campaign_name = request.data.get('camp_name','scoreup')
        query.id = request.data.get('user_id')
        query.used_at = None
        query.save()
        return Response({
    ...
    def get(self, request):
        ...
        query = ScoreupUID.objects.latest('created_at')
...
class BoylesportsuidAPI(APIView):
    def put(self, request):
        query = BoylesportsUID()
        query.campaign_name = request.data.get('camp_name','boylesportstmodd')
        query.id = request.data.get('user_id')
        query.used_at = None
        query.save()
        return Response({
    ...
    def get(self, request):
        ...
        query = BoylesportsUID.objects.latest('created_at')
...
class ScoreUpAPI(APIView):
    ...
    def get(self, request):
        ...
        query_list = ScoreUp.objects.filter(used_at=None).exclude(**exclude_dict_1).order_by('-created_at')[0:25].all()        
        if not query_list:
            query_list = ScoreUp.objects.exclude(**exclude_dict).order_by('-created_at')[0:25].all()
...
class SahiAPI(APIView):
    def put(self, request):
        query = SahiUID()
        query.campaign_name = request.data.get('camp_name','sahimodd')
        query.id = request.data.get('user_id')
        query.used_at = None
        query.save()
        return Response({
    ...
    def get(self, request):
        ...
        query = SahiUID.objects.latest('created_at')
...
class AhamoveuidAPI(APIView):
    def put(self, request):
        query = AhamoveUID()
        query.campaign_name = request.data.get('camp_name','ahamovemodd')
        query.id = request.data.get('user_id')
        query.extra_details = request.data.get('extra_details',{})
        query.used_at = None
        query.save()
    ...
    def get(self, request):
        ...
        query = AhamoveUID.objects.filter(used_at=None).order_by('-created_at')[0:50].first()
    ...
    def post(self, request):
        query = AhamoveUID.objects.order_by('-id').first()
...
class AhamoveoidAPI(APIView):
    ...
    def get(self, request):
        ...
        query = AhamoveOID.objects.filter(used_at=None).order_by('-created_at')[0:50].first()
    ...
    def post(self, request):
        query = AhamoveOID.objects.order_by('-id').first()

        return Response({
            'id':query.id,
        })

class ReevoAPI(APIView):

    def put(self, request):
        query = ReevoNUMID()
        query.campaign_name = request.data.get('camp_name','reevo')
        query.id = request.data.get('user_id')
        query.used_at = None
        try:
            query.save()
    ...
    def get(self, request):
        ...
        query_list = ReevoNUMID.objects.filter(used_at=None).exclude(**exclude_dict_1).order_by('-created_at')[0:25].all()        
        if not query_list:
            query_list = ReevoNUMID.objects.exclude(**exclude_dict).order_by('-created_at')[0:25].all()
...
class MbbankUIDAPI(APIView):
    def put(self, request):
        query = MbbankUID()
        query.campaign_name = request.data.get('camp_name','mbbankmodd')
        query.id = request.data.get('user_id')
        query.used_at = None
        query.save()
        return Response({
    ...
    def get(self, request):
        ...
        query = MbbankUID.objects.latest('created_at')
...
class AstroMiningAPI(APIView):
    def put(self, request):
        query = AstroMining()
        query.campaign_name = request.data.get('camp_name','astrogroceriest2modd')
        query.id = request.data.get('id')
        query.used_at = None
        try:
            query.save()
    ...
    def get(self, request):
        ...
        query = AstroMining.objects.filter(used_at=None).order_by('-created_at')[0:50].first()
    ...
    def post(self, request):
        query = AstroMining.objects.order_by('-id').first()
...
class HealthifymeMiningAPI(APIView):
    def put(self, request):
        query = HealthifymeMining()
        query.campaign_name = request.data.get('camp_name','healthifymetmodd')
        query.id = request.data.get('id')
        query.joinedDate = request.data.get('joinedDate','')
        query.extra_details = request.data.get('extra_details',{})
        query.used_at = None
        try:
            query.save()
    ...
    def get(self, request):
        ...
        query = HealthifymeMining.objects.filter(used_at=None).order_by('-created_at')[0:50].first()
    ...
    def post(self, request):
        query = HealthifymeMining.objects.order_by('-id').first()
...
class DominosturkeyUIDAPI(APIView):
    ...
    def get(self, request):
        ...
        query = DominosturkeyUID.objects.latest('created_at')
...
class DominosturkeyOIDAPI(APIView):
    def put(self, request):
        query = DominosturkeyOID()
        query.campaign_name = request.data.get('camp_name','dominosturkeyauto')
        query.id = request.data.get('user_id')
        query.used_at = None
        query.save()
    ...
    def get(self, request):
        ...
        query = DominosturkeyOID.objects.latest('created_at')
...
class LifestyleOIDAPI(APIView):
    def put(self, request):
        query = LifetyleOrderId_2()
        ...
        try:
            ...
            if 'Duplicate entry' in str(e):
                query = LifetyleOrderId_extra_OID()
                query.campaign_name = request.data.get('camp_name','lifestyleauto')
                query.id = request.data.get('order_id')
                query.airwaybillno = request.data.get('airwaybillno')
                query.order_no = request.data.get('order_no')
    ...
    def get(self, request):
        ...
        query = LifetyleOrderId_2.objects.filter(used_at=None).order_by('-created_at')[0:50].first()
...
class DominosturkeyOID_miningAPI(APIView):
    def put(self, request):
        query = dominosturkey_OID()
        query.campaign_name = request.data.get('camp_name','dominosturkeyauto')
        query.id = request.data.get('order_id')
        query.Tracking_code = request.data.get('Tracking_code')
        query.price = request.data.get('price')
        query.extra_details = request.data.get('extra_details',{})
        query.used_at = None
        try:
    ...
    def get(self, request):
        ...
        query = dominosturkey_OID.objects.filter(used_at=None).order_by('-created_at')[0:50].first()
...
class DanaUIDAPI(APIView):
    def put(self, request):
        query = DanaUID()
        query.campaign_name = request.data.get('camp_name','danamodd')
        query.id = request.data.get('user_id')
        query.used_at = None
        query.save()
        return Response({
    ...
    def get(self, request):
        ...
        query = DanaUID.objects.latest('created_at')
...
class Spinny_OIDAPI(APIView):
    def put(self, request):
        query = Spinny_OID()
        query.campaign_name = request.data.get('camp_name','spinnytauto')
        query.id = request.data.get('order_id')
        query.extra_details = request.data.get('extra_details',{})
        query.used_at = None
        try:
    ...
    def get(self, request):
        ...
        query = Spinny_OID.objects.filter(used_at=None).order_by('-created_at')[0:50].first()
...
class Spinny_valid_OIDAPI(APIView):
    ...
    def get(self, request):
        ...
        query = Spinny_valid_OID.objects.filter(used_at=None).order_by('-created_at')[0:50].first()
...
class Spinny_valid_ID_updater(APIView):
    def post(self, request):
        updated_count = Spinny_valid_OID.objects.update(
            used_at=None,
            channel='',
            network='',
            offer_id=''
...
class EternzUIDAPI(APIView):
    def put(self, request):
        query = EternzUID()
        query.campaign_name = request.data.get('camp_name','eternzmodd')
        query.id = request.data.get('user_id')
        query.used_at = None
        query.save()
        return Response({
    ...
    def get(self, request):
        ...
        query = EternzUID.objects.latest('created_at')
...
class Dominoesgold_UID_API(APIView):
    def put(self, request):
        query = Dominoesgold_UID()
        query.campaign_name = request.data.get('camp_name','dominoesgoldiosmodd')
        query.id = request.data.get('user_id')
        query.balance = request.data.get('balance')
        query.extra_details = request.data.get('extra_details',{})
        query.used_at = None
        try:
            query.save()
    ...
    def get(self, request):
        ...
        query = Dominoesgold_UID.objects.filter(used_at=None, balance__gte=Decimal('0.1')).order_by('-created_at')[0:50].first()
...
class Eternz_OIDAPI(APIView):
    ...
    def get(self, request):
        ...
        query = Eternz_OID.objects.filter(used_at=None).order_by('-created_at')[0:50].first()
    ...
    def post(self, request):
        query = Eternz_OID.objects.order_by('-id').first()

        return Response({
            'id':query.id,
        })
    
class Litres_UID_API(APIView):
    def put(self, request):
        query = Litres_UID()
    ...
    def get(self, request):
        ...
        query = Litres_UID.objects.filter(used_at=None).order_by('-created_at')[0:50].first()
    ...
    def post(self, request):
        query = Litres_UID.objects.order_by('-id').first()
    ...
    def get(self, request):
        ...
        for row in data:
            ...
            if event_name in ["organic", "non-organic", "non_organic"]:
                ...
                # combination = str(Carrier)+"::" + str(Operator) + "::" + str(Mcc)+"::" + str(Mnc)
                # combination = str(OS)+"::" + str(Brand) +"::"+ str(model)
...
class Indian_emailIdsAPI(APIView):

    def put(self, request):
        query = Indian_emailIds()
        query.campaign_name = request.data.get('camp_name','indianemails')
        query.id = request.data.get('email_id')
        query.used_at = None
        try:
            query.save()
            return Response({
    ...
    def get(self, request):
        ...
        query_list = Indian_emailIds.objects.filter(used_at=None).exclude(**exclude_dict_1).order_by('-created_at')[0:25].all()        
        if not query_list:
            query_list = Indian_emailIds.objects.exclude(**exclude_dict).order_by('-created_at')[0:25].all()
...
class NeonUIDAPI(APIView):
    def put(self, request):
        query = NeonUID()
        query.campaign_name = request.data.get('camp_name','neoniosmodd')
        query.id = request.data.get('user_id')
        query.used_at = None
        query.save()
        return Response({
    ...
    def get(self, request):
        ...
        query = NeonUID.objects.latest('created_at')
...
class PlantExpertOIDAPI(APIView):
    def put(self, request):
        query = PlantExpertOID()
        query.campaign_name = request.data.get('camp_name','plantexpertaiiosmodd')
        query.id = request.data.get('order_id')
        query.used_at = None
        query.save()
        return Response({
    ...
    def get(self, request):
        ...
        query = PlantExpertOID.objects.latest('created_at')
...
class MotilalNumberAPI(APIView):
    ...
    def get(self, request):
        ...
        if setUsed:
            query = MotilalNumber.objects.filter(id=data.get('user_id')).update(used_at=timezone.now(), channel=channel, network=network, offer_id=offer_id)
        return Response({
            'body':data,
        })

class SofyClubAPI(APIView):
    ...
    def get(self, request):
        ...
        query = Sofyclub.objects.filter(used_at=None).order_by('-created_at')[0:25].first()      

        data = {
                'user_id':query.id, 'email': query.email
        }
        if setUsed:
            query = Sofyclub.objects.filter(id=data.get('user_id')).update(used_at=timezone.now(), channel=channel, network=network, offer_id=offer_id)
        return Response({
            'body':data,
        })
...
class ApnatimeNumberAPI(APIView):
    ...
    def get(self, request):
        ...
        query = ApnatimeNumber.objects.filter(used_at=None).order_by('-created_at')[0:25].first()      

        data = {
                'user_id':query.id, 'email': query.email
        }
        if setUsed:
            query = ApnatimeNumber.objects.filter(id=data.get('user_id')).update(used_at=timezone.now(), channel=channel, network=network, offer_id=offer_id)
        return Response({
            'body':data,
        })


class ShiprocketCNYAPI(APIView):
    def put(self, request):
        query = ShiprocketCNY()
        query.campaign_name = request.data.get('camp_name','lifestyleauto')
        query.id = request.data.get('order_id')
    ...
    def get(self, request):
        ...
        query = ShiprocketCNY.objects.filter(used_at=None).order_by('-created_at')[0:50].first()
        ...
        if setUsed:
            query = ShiprocketCNY.objects.filter(id=data.get('order_id')).update(used_at=timezone.now(), channel=channel, network=network, offer_id=offer_id)
        return Response({
            'body':data,
        })
    
    
class GloboplayAPI(APIView):

    def put(self, request):
        query = Globoplay()
        query.campaign_name = request.data.get('camp_name','globoplaytmodd')
        query.id = request.data.get('user_id')
        query.used_at = None
        try:
            query.save()
    ...
    def get(self, request):
        ...
        query_list = Globoplay.objects.filter(used_at=None).exclude(**exclude_dict_1).order_by('-created_at')[0:25].all()        
        if not query_list:
            query_list = Globoplay.objects.exclude(**exclude_dict).order_by('-created_at')[0:25].all()
        ...
        if query_list:
            for i in range(3):
                ...
                if setUsed:
                    query = Globoplay.objects.filter(id=data.get('user_id')).update(
                        used_at=timezone.now(),
                        channel_list=new_channel_list,
                        network_list=new_network_list,
                        offer_id_list=new_offer_id_list,
...
class GloboplayUpdater(APIView):
    def post(self, request):
...
class LotterMXAPI(APIView):
    def put(self, request):
        query = LotterMX()
        query.campaign_name = request.data.get('camp_name','lottermxiosmodd')
        query.id = request.data.get('user_id')
        query.IsFullyRegistered = request.data.get('IsFullyRegistered')
        query.IsCompleted = request.data.get('IsCompleted','')
        query.source = request.data.get('source','')
        query.extra_details = request.data.get('extra_details',{})
        query.used_at = None
    ...
    def get(self, request):
        ...
        if setUsed:
            query = LotterMX.objects.filter(id=data.get('user_id')).update(used_at=timezone.now(), channel=channel, network=network, offer_id=offer_id)
        return Response({
            'body':data,
        })
    
    def post(self, request):
        query = LotterMX.objects.order_by('-id').first()

        return Response({
            'id':query.id,
        })
    
class LotterUSAPI(APIView):
    def put(self, request):
        query = LotterUS()
        query.campaign_name = request.data.get('camp_name','thelotterusiosmodd')
        query.id = request.data.get('user_id')
        query.IsFullyRegistered = request.data.get('IsFullyRegistered')
        query.IsCompleted = request.data.get('IsCompleted','')
        query.source = request.data.get('source','')
    ...
    def get(self, request):
        ...
        # query = LotterUS.objects.filter(used_at=None, source = "TheLotterMX", IsFullyRegistered = "Registered", IsCompleted = "Completed").order_by('-created_at')[0:50].first()

        # if not query:
        query = LotterUS.objects.filter(used_at=None, source = "TheLotterUS", IsFullyRegistered = "Registered", IsCompleted = "Not Completed").order_by('-created_at')[0:50].first()
        ...
        if setUsed:
            query = LotterUS.objects.filter(id=data.get('user_id')).update(used_at=timezone.now(), channel=channel, network=network, offer_id=offer_id)
        return Response({
            'body':data,
        })
    
    def post(self, request):
        query = LotterUS.objects.order_by('-id').first()

        return Response({
            'id':query.id,
        })

class PizzahutMYAPI(APIView):
    def put(self, request):
        query = PizzahutMY()
        ...
        query.long = request.data.get('long','')
        query.extra_details = request.data.get('extra_details',{})
        query.used_at = None
...
class FibeUIDAPI(APIView):
    ...
    def get(self, request):
        ...
        query = FibeUID.objects.latest('created_at')
        
        data = {
                'user_id':query.id,
        }
        if setUsed:
            query = FibeUID.objects.filter(id=data.get('user_id')).update(used_at=timezone.now())
        return Response({
            'body':data,
        })

class YangoUIDAPI(APIView):
    def put(self, request):
        query = YangoUID()
        query.campaign_name = request.data.get('camp_name','yangoplayiosmodd')
        query.id = request.data.get('user_id')
        query.used_at = None
        query.save()
        return Response({
    ...
    def get(self, request):
        ...
        query = YangoUID.objects.latest('created_at')
        
        data = {
                'user_id':query.id,
        }
        if setUsed:
            query = YangoUID.objects.filter(id=data.get('user_id')).update(used_at=timezone.now())
        return Response({
            'body':data,
        })


class CrecidineroUIDAPI(APIView):
    def put(self, request):
        query = CrecidineroUID()
        query.campaign_name = request.data.get('camp_name','crecidineromxiosmodd')
        query.id = request.data.get('user_id')
        query.used_at = None
        query.save()
        return Response({
    ...
    def get(self, request):
        ...
        query = CrecidineroUID.objects.latest('created_at')
        
        data = {
                'user_id':query.id,
        }
        if setUsed:
            query = CrecidineroUID.objects.filter(id=data.get('user_id')).update(used_at=timezone.now())
        return Response({
            'body':data,
        })

class FortaprestUIDAPI(APIView):
    def put(self, request):
        query = FortaprestUID()
        query.campaign_name = request.data.get('camp_name','fortaprestiosmodd')
        query.id = request.data.get('user_id')
        query.used_at = None
        query.save()
        return Response({
    ...
    def get(self, request):
        ...
        query = FortaprestUID.objects.latest('created_at')
...
class GalaxyMiningStatsAPI(APIView):
    ...
    def get(self, request):
        ...
        query = GalaxyMiningStats.objects.latest('created_at')
        
        data = {
                'user_id':query.id,
        }
        if setUsed:
            query = GalaxyMiningStats.objects.filter(id=data.get('user_id')).update(used_at=timezone.now())
        return Response({
            'body':data,
        })

class JazzcashOldNumbersAPI(APIView):
    def put(self, request):
        query = JazzcashOldNumbers()
        query.id = request.data.get('user_id')
        query.number_type = request.data.get('number_type')
        query.used_at = None
        query.save()
    ...
    def get(self, request):
        ...
        query = JazzcashOldNumbers.objects.latest('created_at')
        
        data = {
                'user_id':query.id,
        }
        if setUsed:
            query = JazzcashOldNumbers.objects.filter(id=data.get('user_id')).update(used_at=timezone.now())
        return Response({
            'body':data,
        })
