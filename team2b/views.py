...
def mining_apps():
    ...
    'maxfashionindia_OID': 'maxfashionindiaauto', 'bluerewards_uid': 'bluerewardsmodd', 'scoreUp_uid': 'scoreup', 'galaxy_ru_uid':'galaxychatappmetrica', 'indian_number':'niratmodd'}
