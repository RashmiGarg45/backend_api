...
class KisanKonnectAPI(APIView):
    ...
    def get(self, request):
        ...
        query = KisanKonnect.objects.filter(used_at=None, price__gte=Decimal('4000.0')).order_by('-created_at')[0:50].first()
