...
class ConversionStats(APIView):
    def get(self, request):
        ...
        scripts_list = ["ocbcmodd", "raisinggoblinmodd", "galaxytmodd", "muthootfinonemodd", "accorhotelstmodd", "shopeeno1tauto", "musicallyt", "shopeephtauto", "casinoplussmodd", "zee5newmodd", "mcdeliverymodd", "poppolivetmodd", "smartqarzamodd", "magnittmodd", "waylettmodd", "juanhandmodd", "jazzcashmodd", "mxplayertmodd", "bigloanmodd", "kisshttmodd", "betwinnerngmodd", "paymayamodd", "opaymodd", "robotzaimerrmodd", "stolototmodd", "netshoesmodd", "shrirammodd", "credmaxmodd", "tunaikutmodd", "paytmmoneytmodd", "foxtalemodd", "gamerummyprimemodd", "bcsinvestmenttmodd", "myacuvuemodd", "viuhkmodd", "yesmadammodd", "byutmodd", "indigomoddteam2modd", "roxmodd", "cryptocomtmodd", "intercopromodd", "opaynewmodd", "eaptekatauto", "digitalbankmodd", "bbvamodd", "quickcashonlinemodd", "betrmodd", "heliummobilemodd", "kfcmexicotmodd", "comparemodd", "yesmadammodd", "rupeeredeemodd", "zeptodeliverymodd", "easycashtmodd", "finnixtmodd", "myntmodd", "alphacapitalmodd", "r888casinomodd"]
...
class GalaxyChatAPI(APIView):
    ...
    def get(self, request):
        ...
        total_ids_used = GalaxyChat.objects.filter(used_at__startswith=datetime.now().strftime('%Y-%m-%d')).exclude({'bt_list__contains': other_BT}).count()     
        ...
        if total_ids_used >= 300:
            ...
            query_list = GalaxyChat.objects.filter(used_at=None, city__in=russian_cities).exclude(**exclude_dict_1).order_by('-created_at')[0:25].all()
