...
class ConversionStats(APIView):
    def get(self, request):
        ...
        scripts_list = ["boylesportstmodd", "joybuymodd", "ocbcmodd", "raisinggoblinmodd", "galaxytmodd", "naukrigulftmodd", "muthootfinonemodd", "accorhotelstmodd", "shopeeno1tauto", "lionsgateplaytmodd", "musicallyt", "shopeephtauto", "casinoplussmodd", "zee5newmodd", "mcdeliverymodd", "poppolivetmodd", "smartqarzamodd", "magnittmodd", "waylettmodd", "juanhandmodd",'allobankmodd', "jazzcashmodd", "jupitertmodd", "onepuchmanmodd", "mxplayertmodd", "bigloanmodd", "kisshttmodd", "betwinnerngmodd","clonemcdeliverymodd", "danamodd", "paymayamodd", "osagomodd", "mtcmusicmodd", "opaymodd", "heringmodd", "tikettmodd", "etomomodd", "robotzaimerrmodd", "stolototmodd", "netshoesmodd", "shrirammodd", "credmaxmodd", "tunaikutmodd", "paytmmoneytmodd", "foxtalemodd", "gamerummyprimemodd", "bcsinvestmenttmodd", "myacuvuemodd", "viuhkmodd", "yesmadammodd", "byutmodd", "indigomoddteam2modd", "roxmodd", "cryptocomtmodd", "intercopromodd", "waylettnewmodd", "babytrackermodd", "opaynewmodd", "eaptekatmodd", "digitalbankmodd", "bbvamodd", "quickcashonlinemodd", "betrmodd", "heliummobilemodd", "kfcmexicotmodd", "comparemodd", "yesmadammodd", "rupeeredeemodd", "zeptodeliverymodd", "easycashtmodd", "finnixtmodd", "myntmodd", "alphacapitalmodd", "r888casinomodd","mibptmodd", "instamoneyquickmodd","lemon8newmodd","fiverrt2modd","cencemodd"]
