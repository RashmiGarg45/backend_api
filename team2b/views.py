...
class ConversionStats(APIView):
    def get(self, request):
        ...
        scripts_list = ["raisinggoblinmodd", "galaxytmodd", "muthootfinonemodd", "accorhotelstmodd", "shopeeno1tauto", "musicallyt", "shopeephtauto", "casinoplussmodd", "zee5newmodd", "mcdeliverymodd", "poppolivetmodd", "smartqarzamodd", "magnittmodd", "waylettmodd", "juanhandmodd", "mxplayertmodd", "paymayamodd", "opaymodd", "bcsinvestmenttmodd", "myacuvuemodd", "viuhkmodd", "indigomoddteam2modd", "cryptocomtmodd", "intercopromodd", "opaynewmodd"]
