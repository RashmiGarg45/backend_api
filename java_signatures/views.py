...
def events_per_day_stats(campaign_name, event_name, channel, network, offer_id):
    ...
    if campaign_name == "kfcmexicotmodd" and offer_id in ["kfcaosneommp", "kfcmxneommp", "kfcneomacmmp", "kfcneozigmmp", "kfcdormmp", 'test', 'kfcoctappmmp', 'kfcoctfozmmp']:
        return 11
