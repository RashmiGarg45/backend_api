...
if __name__ == "__main__":
    ...
    data = cursor.execute('''UPDATE TATAPALETTE SET OrderId_Status=1 WHERE ShipmentUploadTime LIKE '{}%';'''.format("2023-11"))
    conn.commit()

    data = cursor.execute('''UPDATE TATAPALETTE SET OrderId_Status=1 WHERE ShipmentUploadTime LIKE '{}%';'''.format("2023-10"))
    conn.commit()
                    ...
                    if current_month == upload_time.month:
                        ...
                        while True:   
                            ...
                            if str(awb) not in current_awbs:
                                ...
                                if resp.get("status")=="AWB_NOT_FOUND":
                                    break
